...
<a href="/assets/slides/example-resource-tracker-report-in-metaflow.html" target="_blank">
  <img src="https://sparecores.github.io/resource-tracker/track_resources-card-example.png" style="padding: 30px 0px 30px 30px;" alt="Screenshot of a resource utilization report generated by the Resource Tracker for R package.">
</a>
