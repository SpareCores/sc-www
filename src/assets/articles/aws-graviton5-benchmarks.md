...
Note that when looking at the recent `metal` versions, there's indeed a 73728 KiB -> 196608 KiB jump in that metric, all 192 no-HT CPU cores divided into two symmetric NUMA nodes, each with 96-96 vCPUs sharing over 96 MiB L3 cache (<a href="https://sparecores.com/server/aws/m9g.metal-48xl" target="_blank"><code>m9g.metal-49xl</code></a>):
