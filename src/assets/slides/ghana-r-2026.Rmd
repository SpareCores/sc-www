...
date: "2026-07-10"
conference: "Ghana R Conference 2026"
conference_url: "https://ghana-rusers.org/ghana-r-conference-2026/"
conference_talk_slides: "/assets/slides/ghana-r-2026.html#/coverslide"
...
::: {.centered}
<img src="images/ghana-r.png"
     class="toplogo" style="width: 200px; margin-left: -100px; margin-right: 100px; height: auto; margin-top: 75px; background-color:transparent;" />
:::

<h1 class="subtitle" style="color:#eee; font-size:1.75em; font-weight: bold !important; text-align: center; margin-top:390px; color:#34d399;">
...
<h3 class="author" style="color:#eee;font-size:1.1em;text-align: center !important; font-weight: normal;">
  July 10, 2026 @ Ghana R Conference 2026
</h3>
...
```r {code-line-numbers="2-2" style="margin-top: 20px !important; font-size: 0.85em;"}
library(logger)
...
```r {code-line-numbers="2-3|1,4-5" style="margin-top: 20px !important; font-size: 0.85em;"}
log_threshold(DEBUG)
...
#> TRACE [2025-08-09 04:25:17] 'nrow(mtcars)' => '32L'
```

. . .

```r {code-line-numbers="1-1|3-3" style="margin-top: 20px !important; font-size: 0.85em;"}
log_warnings()
...
log_info('Hello, {name}!')
#> INFO [2025-08-09 00:05:32] Hello, world!
```
...
```r {code-line-numbers="1-1|4|8-9" style="margin-top: 20px !important; font-size: 1em;"}
...
readLines('/var/log/myapp.log')
#> [1] "INFO [2025-08c-09 06:15:22] foo"  "DEBUG [2025-08-09 06:15:22] bar"
```
...
```r {code-line-numbers="1-1|10-10|20-20" style="margin-top: 30px !important; font-size: 1em; height: 600px;"}
...
# {#stickers data-background-image="images/logger-stickers.jpg" transition="convex-in none-out"}
