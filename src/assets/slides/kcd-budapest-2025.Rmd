...
<section class="titleslide slide level1" data-transition="slide-in none-out">
  <h2>&#62;&#62;&#62; input("How much money did you burn on this?!")</h2>

::: {.centered}
<img class="fragment" src="images/TODO.png" style="width:57%;margin-top:-30px;"/>
:::

## >>> input("So which is the best server for LLMs?")

::: {.centered}
<img class="fragment" style="width:100%;" src="images/TODO.png" />
:::
