...
```python {code-line-numbers="|1|19|3|5,10,15|4,9,14|7,12|6,11,16" style="font-size:32px;" }
...
```python {code-line-numbers="4,9-10,15|8,14,19|9-10,15" style="font-size:24px;" }
from random import sample, randint
from metaflow import FlowSpec, step

DICES = [3, 4, 6, 8, 10, 100]
...
```python {code-line-numbers="9-10,15" style="font-size:24px;" }
from random import sample, randint
from metaflow import FlowSpec, step
...
```python {code-line-numbers="" style="font-size:24px;" }
