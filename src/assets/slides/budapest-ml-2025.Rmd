...
```python {code-line-numbers="|1|19|3|5,10,15|4,9,14|7,12|6,11,16" style="font-size:32px;margin-top: 40px !important; height: 515px;" }
...
```python {code-line-numbers="4-5,10-11,16|9,15,20|10-11,16" style="font-size:24px;" }
...
```python {code-line-numbers="10-11,16" style="font-size:24px;" }
from random import sample, randint
from metaflow import FlowSpec, step
...
```python {code-line-numbers="6,11,16,19-21" style="font-size:24px; height: 525px; margin-top: 40px !important;" }
...
::: {.centered}
<img src="images/bye-3-budapest-ml-2024.png" style="background: none;" class="mt--60 w-80" />
:::
