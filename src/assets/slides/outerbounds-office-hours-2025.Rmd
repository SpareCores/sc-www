...
```python {code-line-numbers="1-1|3-11" style="margin-top: 30px !important; font-size: 32px"}
>>> pp(tracker.stats())
defaultdict(<class 'dict'>, {
    'process_cpu_usage': {'mean': 0.14, 'max': 0.26},
    'process_memory': {'mean': 94373.43, 'max': 109308.0},
    'process_gpu_usage': {'mean': 0.0, 'max': 0.0},
    'process_gpu_vram': {'mean': 0.0, 'max': 0.0},
    'process_gpu_utilized': {'mean': 0.0, 'max': 0.0},
    'system_disk_space_used_gb': {'max': 2600.87},
    'system_net_recv_bytes': {'sum': 111299615.0},
    'system_net_sent_bytes': {'sum': 103073415.0},
...
<ul>
  ...
  <li class="fragment">More granular resource mapping (e.g. VRAM)</li>
