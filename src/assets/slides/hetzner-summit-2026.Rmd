...
<script>
  (function () {
    ...
    if (!slide || slide.dataset.vcpuCountBound) return;
    slide.dataset.vcpuCountBound = '1';

    slide.addEventListener('click', function (event) {
      if (!event.target.closest('.vcpu-count-wrapper')) return;
...
FTR there are 611 instance types with 2 vCPUs ... we monitor 8 vendors.

TODO add vendor logos? by alphabetical order?
