...
::: {.notes}
This is very much needed, as although everyone knows that cloud is just another computer,
we often don't really know what kind of computer that is.
:::

## {#old-vs-new transition="slide-in fade-out"}

::: {.notes}
Before the cloud, it was not too difficult to say that the computer running your program

- might became yellow over the years
- and if it still had a turbo button
- you could even open up the housing
