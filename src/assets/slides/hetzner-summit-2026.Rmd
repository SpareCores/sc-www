...
::: {.notes}
although everyone knows that cloud is just another computer,
...
::: {.notes}
WHAT THE HECK is even a virtual CPU?!
...
::: {.notes}
How do I know? Well, we measured! Not only these 2 servers, but actually 3,800...

We solve this visibility problem by burning hundreds of thousands of dollars to
...
.. when it comes to comparing Hetzner Cloud to other cloud providers,
just look around .. having the Summit right at a datacenter is pretty awesome :)
...
TODO let's take a deep breath, and dive into the data! and clarify what we actually do here
...
# $ cat llm-benchmarks/disclaimer.md
...
- `vLLM` benchmarks coming (current status: 1,289 servers)
