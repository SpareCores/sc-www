---
title: "Spare Cores introduction and project updates"
author: Gergely Daroczi
date: "2025-01-30"
conference: "NGI Search Standup #6"
conference_url: "https://www.ngisearch.eu/view/Events/"
conference_talk_url: "https://www.ngisearch.eu/view/Events/Stand-up_meeting"
conference_talk_slides: "/assets/slides/ngi-search-standup-2025.html#/coverslide"
conference_talk_video: "https://www.youtube.com/watch?v=9eSHdynBu8E"
location: "Virtual"
output:
...
<img src="images/NGISearch_logo_tag_icon.svg"
    style="height: 150px; position: fixed; margin-top: 0px; margin-left: 300px; background-color:transparent;"
/>

<h1 class="subtitle" style="color:#eee;font-size:1.75em;text-align: center; margin-top:325px; color:#34d399;">
  Spare Cores introduction<br />and project updates
</h1>
...
<section class="titleslide slide level1" data-transition="slide-in fade-out">
  <h2>&#62;&#62;&#62; from spare_cores import why</h2>
...
## >>> from spare_cores import why {data-transition="fade-in slide-out"}
...
<div class="notes">
to give you an example: we had around 4k jobs/day at a previous role
...
## >>> from spare_cores import why {data-transition="slide-in none-out"}
...
## >>> from spare_cores import why {data-transition="none-in slide-out"}
...
<section class="titleslide slide level1">
  <h2>&#62;&#62;&#62; from spare_cores import intro</h2>
...
<section class="titleslide slide level1" data-transition="slide-in none-out">
  <h2>&#62;&#62;&#62; spare_cores.challenges("quotas")</h2>

::: {.centered}
<img class="fragment" src="images/aws-quota-request-quota.png" style="width:57%;margin-top:-30px;"/>
:::

## >>> spare_cores.challenges("quotas") {data-transition="none-in slide-out"}
...
## >>> spare_cores.challenges("LLMs") {data-transition="slide-in none-out"}

::: {.centered}
<img class="fragment" style="width:100%;" src="images/chatgpt-datasource.png" />
:::

## >>> spare_cores.challenges("LLMs") {data-transition="none-in slide-out"}
...
<section>
<section class="titleslide slide level1" data-transition="slide-in none-out">
  <h2>&#62;&#62;&#62; changelogs.get("spare_cores")</h2>
...
## >>> changelogs.get("spare_cores")  {data-transition="none-in slide-out"}
...
<section>
<section class="titleslide slide level1" data-transition="slide-in none-out">
  <h2>&#62;&#62;&#62; from spare_cores import team</h2>
...
## >>> from spare_cores import team  {data-transition="none-in slide-out"}
...
<section>
<section class="titleslide slide level1" data-transition="slide-in none-out">
    <!-- https://carbon.now.sh/?bg=rgba%288%2C47%2C73%2C1%29&t=theme%3A0bcewbfyk9yl&wt=none&l=python&width=680&ds=false&dsyoff=20px&dsblur=68px&wc=true&wa=true&pv=5px&ph=5px&ln=false&fl=1&fm=Hack&fs=18px&lh=161%25&si=false&es=2x&wm=false&code=%253E%253E%253E%2520import%2520os%250A%253E%253E%253E%2520import%2520signal%250A%253E%253E%253E%2520os.kill%28os.getpid%28%29%252C%2520signal.SIGKILL%29%2520%2520%250A%250A%253E%253E%253E%2520visit%28%27https%253A%252F%252Fsparecores.com%27%29%250A%253E%253E%253E%2520email%28%27daroczig%2540sparecores.com%27%29%2520%2520%2520%2520%2520%2520%2520%250A%253E%253E%253E%2520follow%28%27%2540SpareCores%27%29%250A%250A%253E%253E%253E%2520os._exit%28status%253D0%29%250AProcess%2520finished%2520at%252011%253A50%253A00%2520%28Jan%252030%252C%25202024%29%2520 -->

::: {.centered}
<img src="images/by-ngi-search-standup-6-1.png" style="background: none;" class="mt--45 w-75" />
:::
...
::: {.centered}
<img src="images/by-ngi-search-standup-6-2.png" style="background: none;" class="mt--45 w-75" />
:::
...
::: {.centered}
<img src="images/by-ngi-search-standup-6-3.png" style="background: none;" class="mt--45 w-75" />
:::
