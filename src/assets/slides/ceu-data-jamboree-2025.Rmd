...
::: {.centered}
<img src="images/shinyproxy-homepage.png" style="width:52%; margin-top: -30px;" alt="ShinyProxy homepage"/>
:::
...
<div class="vcenter centered">
  <img style="margin-top:-30px;width:95%;" src="images/sc-www-search-k3s-control-plane.png" alt="Search for cheap servers at sparecores.com" />
</div>

## >>> from hetzner import cloud

<div class="vcenter centered">
  <img style="margin-top:-30px;width:95%;" src="images/sc-www-search-k3s-control-plane-hetzner.png" alt="Search for cheap cloud servers at Hetzner Cloud" />
</div>

## >>> from hetzner import dedicated {transition="slide-in convex-out"}

<div class="vcenter centered">
  <img style="margin-top:-30px;width:95%;" src="images/sc-www-search-k3s-worker-hetzner.png" alt="Search for cheap dedicated servers at Hetzner Cloud" />
</div>
