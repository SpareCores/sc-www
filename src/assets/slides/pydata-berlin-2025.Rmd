...
<ul style="font-size: 0.8em;">
  <li>100K, 1M, 10M training data from 2005/2006</li>
  <li>100K test data from 2007</li>
</ul>
...
<ul style="font-size: 0.8em;">
  <li>Single Docker image with CPU and GPU builds of GBM implementations</li>
  ...
  <li class="fragment">Use `@szilard`'s training and test files</li>
