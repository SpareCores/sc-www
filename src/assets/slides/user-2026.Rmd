...
# > ??`Spare Cores` {#intro transition="convex-in convex-out"}
...
```r {code-line-numbers="1-4|6-10|12|13-72" style="margin-top: 20px !important; height: 640px;"}
> library(reticulate)
...
# > TODO {transition="convex-in slide-out"}



# > browseURL("meet.sparecores.com") { data-transition="convex-in convex-out"}
...
::: {.centered}
<img src="images/bye-r-2.png" style="background: none; margin-top: 15px !important;" class="w-80" />
:::
