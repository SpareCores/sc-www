export const SERVER_TABLE_SCORE_TOOLTIP =
...
export const SERVER_TABLE_SCORE_PER_PRICE_TOOLTIP =
...
export const SERVER_TABLE_BENCHMARK_TOOLTIP =
  "Performance benchmark score as per the selected Benchmark at the top of the table.";

export const SERVER_TABLE_BENCHMARK_EFFICIENCY_TOOLTIP =
