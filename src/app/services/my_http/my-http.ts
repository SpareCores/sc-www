    ...
    try {
      ...
      if (method === "GET") {
        response = await firstValueFrom(
          this.httpClient.get(url.toString(), { headers, observe }),
        );
      } else if (method === "POST") {
        response = await firstValueFrom(
          this.httpClient.post(url.toString(), body, { headers, observe }),
        );
      } else if (method === "PATCH") {
        response = await firstValueFrom(
          this.httpClient.patch(url.toString(), body, { headers, observe }),
        );
      } else if (method === "DELETE") {
        response = await firstValueFrom(
          this.httpClient.delete(url.toString(), { headers, observe }),
        );
      }
