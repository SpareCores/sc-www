...
export namespace Table {
   ...
   */
  export namespace TableDatabaseTableDatabaseGet {
    export type RequestParams = {};
    export type RequestQuery = {};
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = TableDatabaseTableDatabaseGetData;
  }
   ...
   * @secure
   */
  export namespace TableDatabasePriceTableDatabasePriceGet {
    export type RequestParams = {};
    export type RequestQuery = {
      /**
       * Vendor
    ...
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = TableDatabasePriceTableDatabasePriceGetData;
  }
   ...
   */
  export namespace TableDatabaseStorageTableDatabaseStorageGet {
    export type RequestParams = {};
    export type RequestQuery = {};
    export type RequestBody = never;
    export type RequestHeaders = {};
    export type ResponseBody = TableDatabaseStorageTableDatabaseStorageGetData;
  }
